...
## File Descriptions
### Mandatory
**[0-binary_to_uint.c](0-binary_to_uint.c)** - function that converts a binary number to an .
...
**[3-set_bit.c](3-set_bit.c)** - function that sets the value of a bit to  at a given index.

**[4-clear_bit.c](4-clear_bit.c)** - function that sets the value of a bit to  at a given index.
